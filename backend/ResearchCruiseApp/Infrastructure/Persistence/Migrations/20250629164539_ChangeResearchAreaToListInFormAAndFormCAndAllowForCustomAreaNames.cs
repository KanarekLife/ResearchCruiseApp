        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DifferentName = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResearchAreaDescriptionsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FormAResearchAreaDescription", x => new { x.FormsAId, x.ResearchAreaDescriptionsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FormCResearchAreaDescription", x => new { x.FormsCId, x.ResearchAreaDescriptionsId });
                    table.ForeignKey(
