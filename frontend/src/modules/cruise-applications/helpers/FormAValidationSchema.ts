    ...
    .and(
      z
        .object({
          ...
          researchTasks: ResearchTaskDtoValidationSchema.array().min(
            1,
            'Co najmniej jedno zadanie badawcze jest wymagane'
          ),
        ...
        .refine((val) => {
          ...
          if (acceptablePeriod.length === 0 || optimalPeriod.length === 0) {
            return true;
          }
