    ...
    >
      {confirmationMode ?
        <div className="grid grid-cols-2 gap-4">
          ...
          <AppButton type="submit" className="gap-4 !justify-center w-36 lg:w-48" variant="primary" onClick={() => setConfirmationMode(false)}>
            Anuluj
          </AppButton>
        ...
        <>
          <AppButton className="gap-4 !justify-center w-36 lg:w-48" variant="danger" onClick={() => setConfirmationMode(true)}>
            <TrashFillIcon className="h-4 w-4" />
            Odrzuć zgłoszenie
          </AppButton>
        </>
